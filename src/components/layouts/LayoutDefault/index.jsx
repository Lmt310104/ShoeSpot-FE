      ...
      <div className="layout-default">
        <header className="layout-default__header">
          <div className="layout-default__Home">
            <Link to="/" className="layout-default__Link">
              Home
            </Link>
          </div>
          <div className="layout-default__Contact">
            <Link to="/contact" className="layout-default__Link">
              Contact
            </Link>
          </div>
          <div className="layout-default__About">
            <Link to="/about" className="layout-default__Link">
              About
            </Link>
          </div>
        ...
        <footer className="layout-default__footer">
          <div>
            ...
            <a
              ...
              className="layout-default__social"
            >
              <FaFacebook />
            </a>
            <a
            ...
            <a href="https://discord.com/" className="layout-default__social">
              <RxDiscordLogo />
            </a>
          </div>
        </footer>
